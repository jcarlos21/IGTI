...
const l=Object(d["lazy"])(()=>Promise.all([t.e(6),t.e(7),t.e(8),t.e(12),t.e(144),t.e(654)]).then(t.bind(null,"mftS")))
...
const y=Object(i["lazy"])(()=>Promise.all([t.e(6),t.e(7),t.e(8),t.e(12),t.e(629)]).then(t.bind(null,"FB/m")))
...
const O=Object(i["useState"])(null),C=Object(s["a"])(O,2),A=C[0],z=C[1]
const E=Object(i["useRef"])(c.open)
function I(){S([])
z(null)}function x(e){k.find(n=>n.id===e.id)||S(k.concat([e]))}function L(e){S(k.filter(n=>n.id!==e.id))}function T(){return Object(v["a"])({method:"POST",path:"/api/v1/users/self/content_shares",body:Object(r["a"])({},n,{receiver_ids:k.map(e=>e.id)})})}function w(){z("info")
T().then(B).catch(e=>{console.error(e)
e.response&&console.error(e.response)
z("error")})}function B(){Object(p["c"])(_.t("Content share started successfully"))()
c.onDismiss()}function R(){return l.a.createElement(l.a.Fragment,null,Object(a["a"])(u["a"],{onClick:c.onDismiss},void 0,_.t("Cancel")),Object(a["a"])(u["a"],{disabled:0===k.length||"info"===A,variant:"primary",margin:"0 0 0 x-small",onClick:w},void 0,_.t("Send")))}const K=Object(a["a"])(h["a"],{as:"div",textAlign:"center"},void 0,Object(a["a"])(g["a"],{renderTitle:_.t("Loading")}))
if(c.open!==E.current){E.current=c.open
I()}let F=""
"info"===A?F=_.t("Starting content share"):"error"===A&&(F=_.t("Error starting content share"))
const q=F?Object(a["a"])(b["a"],{variant:A},void 0,Object(a["a"])("div",{role:"alert","aria-live":"assertive","aria-atomic":true},void 0,F),"info"===A?m:null):null
return l.a.createElement(f["a"],Object.assign({label:_.t("Send To..."),size:"medium"},c,{footer:Object(a["a"])(R,{})}),Object(a["a"])(i["Suspense"],{fallback:K},void 0,q,Object(a["a"])(y,{courseId:t,selectedUsers:k,onUserSelected:x,onUserRemoved:L})))}},qBwj:function(e,n,t){"use strict"
var a=t("17x9")
var r=t("EUQ6")
...
//# sourceMappingURL=45-c-369d183b2a.js.map