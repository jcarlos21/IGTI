...
Object(C["a"])(o()(this).data("service").service,e=>{o()("#instructure_link_prompt").dialog("close")
...
r.dialog({width:425,height:"auto",title:"Link to Website URL",open(){o()(this).find(".prompt").focus().select()}})}function D(e,t){D.counter=D.counter||0
true==t&&0!=D.counter?D.counter=(D.counter+1)%5:o()(e.getBody()).find("a").each((function(){const e=new S
const t=o()(this)
...
t.text()===t.attr("href")&&i<1&&e.titleYouTubeText(t)}}))}function O(e){if(F.get(e)||void 0===e.on)return
...
F.set(e,true)}var I={buttonToImg:B,prepEditorForDialog:L,buildLinkClasses:R,bindLinkSubmit:P,renderDialog:N,updateLinks:D,initEditor:O}
i("q1tI")
var V=i("i8i4")
var q=i.n(V)
...
Promise.all([i.e(1),i.e(3),i.e(5),i.e(19),i.e(28),i.e(604)]).then(i.bind(null,"/wcz")).then(t=>{let i=t.default
const r=document.createElement("div")
document.body.appendChild(r)
q.a.render(Object(p["a"])(i,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(x["a"])(),resourceSelectionUrl:o()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),r,(function(){n=this}))})
const a=[]
const s=[]
...
e.ui.registry.addButton("instructure_external_button_".concat(t.id),{onAction:()=>t.onAction(),tooltip:t.title,icon:"favorite_lti_tool_".concat(t.id),title:t.title})})}if(a.length){const t=function(){const t=w.clumpedButtonMapping(a,e,e=>n.open(e))
w.attachClumpedDropdown(o()("#".concat(this._id)),t,e)}
...
Promise.all([i.e(4),i.e(647)]).then(i.bind(null,"F+Bh")).then(t=>{let i=t.default
const n=new i(r.ed)
e.equationCB(n)})})
document.addEventListener("tinyRCE/initLinks",t=>{let i=t.detail
I.renderDialog(i.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(4),i.e(8),i.e(106),i.e(97),i.e(147),i.e(652)]).then(i.bind(null,"Dwgn")).then(i=>{let r=i.default
const n=new r(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(n)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(720).then(i.bind(null,"gg/z")).then(i=>{let r=i.default
r(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{W.init(t.detail.ed,t.detail.url,g["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(39),i.e(721)]).then(i.bind(null,"xR7n")).then(i=>{let r=i.default
...
this.loadRCE(e=>{e.renderIntoDiv(n,a,e=>{e.mceInstance().on("init",()=>i(r,Z.wrapEditor(e)))})})},loadSidebarOnTarget(e,t){if(ENV.RICH_CONTENT_SKIP_SIDEBAR)return
const i=X()
...
ee||(ee=(window.ENV.use_rce_enhancements?Promise.all([i.e(1),i.e(3),i.e(5),i.e(6),i.e(7),i.e(8),i.e(9),i.e(10),i.e(12),i.e(15),i.e(16),i.e(20),i.e(18),i.e(22),i.e(30),i.e(38),i.e(58),i.e(67),i.e(78),i.e(90),i.e(104),i.e(123),i.e(171),i.e(312)]).then(i.bind(null,"Idzl")):Promise.all([i.e(1),i.e(3),i.e(5),i.e(6),i.e(7),i.e(10),i.e(15),i.e(16),i.e(20),i.e(18),i.e(23),i.e(22),i.e(38),i.e(58),i.e(67),i.e(79),i.e(78),i.e(104),i.e(114),i.e(123),i.e(125),i.e(139),i.e(313)]).then(i.bind(null,"66gZ"))).then(e=>{this.RCE=e
G()
return e}))
...
const a=ENV.LOCALE
const o=Object.keys(Q["a"]).map(e=>({id:e,label:Q["a"][e]})).sort((e,t)=>e.id===a?-1:t.id===a?1:e.label.localeCompare(t.label,a))
...
return{defaultContent:e.value||t.defaultContent,editorOptions:m.bind(null,i,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,onBlur:t.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:X(),languages:o,autosave:s}}}
t["a"]=te}}])

//# sourceMappingURL=17-c-ae47fbd9ad.js.map