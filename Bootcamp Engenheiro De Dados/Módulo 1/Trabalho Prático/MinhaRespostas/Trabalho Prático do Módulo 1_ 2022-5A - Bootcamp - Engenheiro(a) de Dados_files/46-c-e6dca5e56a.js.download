(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[46],{"13m+":function(e,t,o){"use strict"
var c=o("17x9")
var l=o.n(c)
var a=o("v0Tn")
...
d.course=i({id:n.isRequired,name:n.isRequired,course_code:n.isRequired,term:d.term.isRequired,teachers:r(i({display_name:n.isRequired})),teacher_count:n,sis_course_id:n})
...
const _=this._queryString([{per_page:"100"},{blueprint:"false"},{blueprint_associated:"false"},{"include[]":"term"},{"include[]":"teachers"},{teacher_limit:"5"},{search_term:l},{enrollment_term_id:i}])
...
const r={send_notification:o}
i&&(r.copy_settings=true)
l&&a&&(r.comment=a)
n&&(r.publish_after_initial_sync=true)
return c["a"].post("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/migrations"),r)},checkMigration(e){return this.getMigrations(e).then(e=>{let t=a["a"].void
...
return Object(c["a"])("span",{className:"bpc-lock-toggle"},void 0,o)}}j.defaultProps={isToggleable:false,onClick:()=>{}}
o.d(t,"default",(function(){return y}))
class y{constructor(){this.toggleLocked=()=>{const e=this.props.itemType
...
this.toggleNode?e():j.setupRootNode(this.props.toggleWrapperSelector,this.props.toggleWrapperChildIndex||0,t=>{this.toggleNode=t
e()})}renderLockToggle(){if(!this.props.toggleWrapperSelector)return
this.setupToggle(()=>{d.a.render(Object(c["a"])(j,{isLocked:this.state.isLocked,isToggleable:"show"===this.props.page&&this.state.isMasterContent,onClick:this.toggleLocked}),this.toggleNode)})}renderBanner(){this.bannerNode||(this.bannerNode=C.setupRootNode())
...
//# sourceMappingURL=46-c-e6dca5e56a.js.map