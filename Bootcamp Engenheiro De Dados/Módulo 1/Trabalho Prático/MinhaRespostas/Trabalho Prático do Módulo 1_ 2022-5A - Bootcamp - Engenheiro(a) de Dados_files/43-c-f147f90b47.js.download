(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[43],{"7FZx":function(i,l,e){"use strict"
var u=e("pQTu")
var t=e("m0r6")
...
e("jQeR")
e("0sPK")
var s=u["default"].scoped("publish_btn_module")
var b=e("ouhR")
var n=e.n(b)
var p=e("FIFq")
var h=e.n(p)
var a=e("5Ky4")
e("Z+Ib")
var o=function(i,l){for(var e in l)_.call(l,e)&&(i[e]=l[e])
function u(){this.constructor=i}u.prototype=l.prototype
i.prototype=new u
i.__super__=l.prototype
return i},_={}.hasOwnProperty
...
return null!=(i=this.model)?i.on("change:unpublishable",(e=this,function(){if(!e.model.get("unpublishable")&&e.model.get("published"))return e.disable()})):void 0
var e}
...
l.prototype.render=function(){this.$el.is("button")||this.$el.attr("role","button")
...
var f=e("RtEy")
var g=e.n(f)
e.d(l,"a",(function(){return m}))
m.defaultProps={padding:"small",contentPadding:"0",errorImageUrl:g.a}
function m(i){let l=i.padding,e=i.headerPadding,s=i.contentPadding,b=i.errorSubject,p=i.errorCategory,f=i.errorImageUrl,g=i.label,m=i.title,v=i.onDismiss,P=i.children,y=Object(t["a"])(i,["padding","headerPadding","contentPadding","errorSubject","errorCategory","errorImageUrl","label","title","onDismiss","children"])
null==e&&(e="0 0 ".concat(l," 0"))
null==m&&(m=g)
var C=Object(u["a"])(_["a"].Item,{grow:true},void 0,Object(u["a"])(r["a"],{ellipsis:true},void 0,m))
function j(){return Object(u["a"])(_["a"],{as:"div",padding:e},void 0,C,Object(u["a"])(_["a"].Item,{},void 0,Object(u["a"])(a["a"],{onClick:v,size:"small"},void 0,n.t("Close"))))}var K=Object(u["a"])(k["a"],{imageUrl:f,errorSubject:b,errorCategory:p})
var O=Object(u["a"])(o["a"],{as:"div",padding:s,width:"100%",height:"100%"},void 0,P)
function z(){return Object(u["a"])(d["a"],{errorComponent:K},void 0,O)}return h.a.createElement(c["a"],Object.assign({label:g,onDismiss:v},y),Object(u["a"])(o["a"],{as:"div",padding:l,position:"absolute",insetBlockStart:"0",insetBlockEnd:"0",insetInlineStart:"0",insetInlineEnd:"0"},void 0,Object(u["a"])("div",{style:{display:"flex",flexDirection:"column",width:"100%",height:"100%"}},void 0,j(),Object(u["a"])("div",{style:{position:"relative",flex:1}},void 0,z()))))}},"p9+C":function(i,l,e){"use strict"
e.d(l,"a",(function(){return s}))
var u=e("q1tI")
var t=e.n(u)
e("17x9")
class s extends t.a.Component{constructor(){super(...arguments)
this.state={hasError:false,error:null}}static getDerivedStateFromError(i){return{hasError:true,error:i}}render(){if(this.state.hasError)return t.a.cloneElement(this.props.errorComponent,{errorSubject:this.state.error.message})
return this.props.children}}}}])

//# sourceMappingURL=43-c-f147f90b47.js.map