...
return"Assignment"}
i.prototype.objectTypeDisplayName=function(){if(this.isQuiz()||this.isQuizLTIAssignment()&&z())return g.t("Quiz")
...
i.prototype.defaultDates=function(){return new h["a"]({due_at:this.get("due_at"),unlock_at:this.get("unlock_at"),lock_at:this.get("lock_at")})}
...
null!=(t=e.assignment_overrides)&&(e.assignment_overrides=new d["a"](t))
...
//# sourceMappingURL=27-c-d9d160147b.js.map