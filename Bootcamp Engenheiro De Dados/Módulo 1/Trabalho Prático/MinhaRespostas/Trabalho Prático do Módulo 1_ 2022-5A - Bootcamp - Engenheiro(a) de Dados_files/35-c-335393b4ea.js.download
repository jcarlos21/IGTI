(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[35,641,650,651,707],{"0crz":function(e,t,n){"use strict"
var r=n("ouhR")
var i=n.n(r)
var a=n("pQTu")
var s=n("m0r6")
...
var g=n("xe+K")
var p=n("cbNQ")
var _=function(e,t){return function(){return e.apply(t,arguments)}},f=function(e,t){for(var n in t)m.call(t,n)&&(e[n]=t[n])
function r(){this.constructor=e}r.prototype=t.prototype
e.prototype=new r
e.__super__=t.prototype
return e},m={}.hasOwnProperty,v=[].slice
t["a"]=function(e){f(t,e)
function t(){this.checkUnload=_(this.checkUnload,this)
...
t.prototype.submit=function(e,t){var n,r,i,a,s,l,u,d,h
null==t&&(t=g["d"])
null!=e&&e.preventDefault()
this.hideErrors()
d=this.$el.find("textarea[data-rich_text]").toArray()
u=true
d.length>0&&window.ENV.use_rce_enhancements&&(u=d.map((function(e){return t(o()(e),"checkReadyToGetCode",window.confirm)})).every((function(e){return e})))
if(!u)return
r=this.getFormData()
s=this.validateBeforeSave(r,{})
if(0===c.a.keys(s).length){a=new o.a.Deferred
h=this.saveFormData(r)
h.then(this.onSaveSuccess.bind(this),this.onSaveFail.bind(this))
h.fail((p=this,function(){a.reject()
...
this.trigger("submit")
return h}i=c.a.map(o()("[data-error-type]"),(function(e){return o()(e).attr("data-error-type")}))
n=c.a.chain(c.a.keys(s)).reject((function(e){return c.a.includes(i,e)})).value()
l=n[0]||i[0]
...
t=c.a.clone(e)
c.a.each(t,(n=this,function(e,r){return t[r]=n.castJSON(e)}))
var n
return t}
...
let r=n.offset(),a=n.outerWidth(),s=n.outerHeight(),o=r.top,l=o+s,c=r.left,u=c+a,d="html,body"==this.selector?i.a.windowScrollTop():this.scrollTop(),h=this.scrollLeft(),g=this.outerHeight(),p=this.outerWidth()
...
l-=e.top
c-=e.left
u-=e.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){g=i()(window).height()
i()("#wizard_box:visible").length>0&&(g-=i()("#wizard_box:visible").height())
p=i()(window).width()
o-=d
c-=h
l-=d
u-=h}o<0||g<s&&l>g?t.scrollTop=o+d:l>g&&(t.scrollTop=l+d-g+20)
...
return e.length?e:this}}function u(){return this.name&&!this.disabled&&(this.checked||s.test(this.nodeName)||l.test(this.type))}function d(e,t){"string"===typeof t&&(t=t.replace(o,"\r\n"))
...
return i.a.isArray(t)?t.map(e=>d(this.name,e)):d(this.name,t)}i.a.fn.serializeForm=function(){return this.map(c).filter(u).map(h).get()}},TBRb:function(e,t,n){"use strict"
var r=n("ouhR")
var i=n.n(r)
var a=n("GLiE")
var s=n.n(a)
...
return n},showErrors:function(e,t){var n,r,a,s,l,c,u,d
null==t&&(t=false)
d=[]
for(a in e){r=e[a]
...
null!=(c=n.errorBox(i.a.raw(""+s)))&&null!=(u=c.css("z-index","1100"))&&u.attr("role","alert")
...
const e=s.height()-(r.offset().top+r.outerHeight())+(i.height()-a.height()),c=Math.max(400,e)
l.height(c)
...
//# sourceMappingURL=35-c-335393b4ea.js.map